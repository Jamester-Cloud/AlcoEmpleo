  ...
  return (
    <div className="bg-blue-950 text-white flex items-center justify-center p-2">
      <div className="container mx-auto">
        ...
        >
          <Col className="text-white p-4 md:w-1/2 md:mr-4 md:mb-0 mb-4 h-full">
          <Image
                           src="/Logo 3.png"
                           width={1730}
                           height={2534}
          ...
          {/* Direccion/Mapa */}
          <Col className="flex flex-col items-center justify-center rounded-2xl text-white p-4 md:w-1/2 h-full">
            <h2 className="text-lg md:text-xl font-bold text-center">
