          ...
          <Card className="w-80 h-64">
            <Card.Header>
              <div className="mt-3 mb-4">
                <img src="/AlcoSloganLogo.png" className="w-full" alt="Logo" />
              </div>
            </Card.Header>
            <Card.Body className="text-center">
              ...
              <button type="button" className="btn btn-success btn-sm rounded">
                       <Link href={`https://wa.me/${candidato.personaData.telefono}?text=Hola%20te%20estamos%20contactando%20desde%20La%20web%20AlcoEmpleo%20y%20estamos%20Interesados%20en%20tu%20perfil`} className="mdi mdi-whatsapp  text-white text-decoration-none">  Enviar mensaje
                       </Link>
                   </button>
