...
import { faMagnifyingGlass,faUser,faCog,faCartShopping,faLock,faMapMarkerAlt,faClock } from "@fortawesome/free-solid-svg-icons";
import HomeCandidate from "../Home/HomeCandidate";
